        ...
        <div className="container max-w-4xl py-12">
          ...
          <div className="space-y-8">
            ...
            <section className="space-y-4">
              ...
              <p>
                VoteX ("we", "our", or "us") is committed to protecting your
                privacy. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your information when you use our online
                election platform ("Service").
              </p>
              <p>
                We take your privacy seriously and have implemented measures
                designed to protect your personal information. Please read this
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Date of birth</li>
                <li>
                  Government-issued identification (for voter verification
                  purposes)
                </li>
                <li>
                  Other information you provide when creating an account or
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold">
                4. Ballot Secrecy and Vote Privacy
              </h2>
              <p>
                We are committed to maintaining the secrecy of your ballot. Our
                system is designed to separate your identity from your voting
                choices. While we maintain records of who has voted in an
                election, the specific choices made on your ballot cannot be
            ...
            <section className="space-y-4">
              ...
              <p>
                Election data may be retained for longer periods as required by
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                services that are not owned or controlled by VoteX. We have no
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                16 without parental consent. We do not knowingly collect
                personally identifiable information from children under 16. If
            ...
            <section className="space-y-4">
              ...
              <p className="font-medium">privacy@VoteX.com</p>
              <p>VoteX, Inc.</p>
