        ...
        <div className="container max-w-4xl py-12">
          ...
          <div className="space-y-8">
            ...
            <section className="space-y-4">
              ...
              <p>
                By accessing or using the VoteX platform ("Service"), you agree
            ...
            <section className="space-y-4">
              ...
              <p>
                VoteX provides an online platform for conducting secure
                electronic voting and elections. The Service includes voter
                registration, identity verification, ballot creation, vote
                casting, and result tabulation.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                maintaining the security of your account and password. VoteX
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold">
                4. Voter Eligibility and Verification
              </h2>
              <p>
                Users must meet the eligibility requirements specified for each
                election to participate as voters. VoteX reserves the right to
                verify voter identity and eligibility through various means,
                which may include requesting government-issued identification or
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Attempting to manipulate election results or cast multiple
                  votes
                </li>
                <li>
                  Using any robot, spider, crawler, scraper, or other automated
                  means to access the Service
                </li>
                <li>
                  Selling or transferring your account or voter credentials
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                In no event shall VoteX, nor its directors, employees, partners,
            ...
            <section className="space-y-4">
              ...
              <p className="font-medium">support@VoteX.com</p>
            </section>
          </div>
        </div>
      </main>
